  ...
  .directive('crudTable',['Modal','$injector','$loading','socket','toastr', function (Modal,$injector,$loading,socket,toastr) {
    return {
      ...
      link: function (scope, element, attrs) {
        ...
        var merchantId = attrs.merchant;
        scope.data = [];
        // scope.loadingTable = true;
        $loading.start('crudTable');
        scope.data =api.query({merchantId:merchantId},function() {
        ...
        scope.edit = function(item) {
          ...
          Modal.show(item,{title:title, api:attrs.api, columns: obj, disabledColumn: attrs.disabledcolumn,uploadimage:attrs.uploadimage});
        };
