...
var MerchantCategory = require('../api/merchantcategory/merchantcategory.model');
var Shop = require('../api/shop/shop.model');
var Brand = require('../api/brand/brand.model');
var Banner = require('../api/banner/banner.model');
...
MerchantCategory.find(function (err, data) {
	  if(data.length < 1){
		 MerchantCategory.create({
	    "_id" : "980123abd4124c770bfc4b57",
	    "name" : "Shop",
	    "category" : 1,
	    "parentCategory" : 0,
	    "active" : true,
	    ...
	    "description" : "shopping"
	      ...
	      "_id" : "980123b6d4124c770bfc4b58",
	      "name" : "Eat",
	      "category" : 2,
	      "parentCategory" : 0,
	      "active" : true,
	      "__v" : 0,
	      "description" : "Restaurents"
	  },{
	      "_id" : "980123b6d4124c770bfc4b57",
	      "name" : "Beauty and Style",
	      "category" : 3,
	      "parentCategory" : 0,
	      "active" : true,
	      "__v" : 0,
	      "description" : "beauty and style"
	  },{
	      "_id" : "980123b6d4124c770bfc4b56",
	      "name" : "Health",
	      "category" : 4,
	      "parentCategory" : 0,
	      "active" : true,
	      "__v" : 0,
	      "description" : "doctors, clinics, medical shops and ambulances"
	  },{
	      "_id" : "980123d2d4124c770bfc4b59",
	      "name" : "Dresses",
	      "category" : 1000,
	      "parentCategory" : 1,
	      "active" : true,
	      ...
	      "_id" : "980123dad4124c770bfc4b68",
	      "name" : "Veg restaurants",
	      "category" : 2000,
	      "parentCategory" : 2,
	      "active" : true,
	      "__v" : 0,
	      "description" : "veg restaurants"
	  },{
	      "_id" : "980123dad4124c770bfc4b70",
	      "name" : "Veg/non veg restaurants",
	      "category" : 2001,
	      "parentCategory" : 2,
	      "active" : true,
	      "__v" : 0,
	      "description" : "veg/non veg restaurants"
	  }, function() {
	        console.log('finished populating merchant categories');
	    });
	  }
	});
